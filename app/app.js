          ...
          <div className="panel panel-default fb-status-update-entry">
            <div className="panel-body">
              <ul className="nav nav-pills">
                ...
                <li role="presentation">
                  <a href="#"><span className="glyphicon glyhicon-th"></span>
              ...
              <div className="row">
                <div className="col-md-10">
                  <div className="media">
                    ...
                    <div className="media-body">
                      <a href="#">Someone</a>
                      <br/> Yesterday at 3:48pm · Auston, TX ·
                      <span className="glyphicon glyphicon-user"></span>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-md-12">
                  <ul className="list-inline">
                    <li>
                      <a href="#"><span className="glyphicon glyphicon-thumbs-up"></span>
                      Like</a>
                    </li>
                    <li>
                      <a href="#"><span className="glyphicon glyphicon-comment"></span>
                      Comment</a>
                    </li>
                    <li>
                      <a href="#"><span className="glyphicon glyphicon-share-alt"></span>
                      Share</a>
                    </li>
                  </ul>
                </div>
